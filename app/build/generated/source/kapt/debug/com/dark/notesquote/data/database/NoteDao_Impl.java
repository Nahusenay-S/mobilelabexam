...
public final class NoteDao_Impl implements NoteDao {
  ...
  public NoteDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfNoteEntity = new EntityInsertionAdapter<NoteEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `notes` (`id`,`title`,`content`,`timestamp`,`isFavorite`) VALUES (nullif(?, 0),?,?,?,?)";
      }
  ...
  @Override
  public Object insertNote(final NoteEntity note, final Continuation<? super Unit> arg1) {
  ...
  @Override
  public Object deleteNote(final NoteEntity note, final Continuation<? super Unit> arg1) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
      ...
      public List<NoteEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpTimestamp,_tmpIsFavorite);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getNoteById(final int id, final Continuation<? super NoteEntity> arg1) {
      ...
      public NoteEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsFavorite);
            _tmpIsFavorite = _tmp != 0;
            _result = new NoteEntity(_tmpId,_tmpTitle,_tmpContent,_tmpTimestamp,_tmpIsFavorite);
          } else {
            _result = null;
          }
          return _result;
